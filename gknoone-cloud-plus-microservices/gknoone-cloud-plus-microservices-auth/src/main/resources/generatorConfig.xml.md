   ...
   <classPathEntry location="/Program Files/IBM/SQLLIB/java/db2java.zip" />
    ...
    <context id="DB2Table" defaultModelType="flat" targetRuntime="MyBatis3">
        ...
        <!-- java模型创建器，是必须要的元素
         ...
         -->
        <javaModelGenerator targetPackage="com.gknoone.cloud.plus.provider.auth.model" targetProject="src/main/java">
        ...
        <!-- 生成SQL map的XML文件生成器，
         ...
         -->
        <sqlMapGenerator targetPackage="com.gknoone.cloud.plus.provider.auth.mapper" targetProject="src/main/resources">
            <!-- 在targetPackage的基础上，根据数据库的schema再生成一层package，最终生成的类放在这个package下，默认为false -->
            <property name="enableSubPackages" value="true"/>
        </sqlMapGenerator>
        ...
        -->
        <javaClientGenerator targetPackage="com.gknoone.cloud.plus.provider.auth.mapper" type="XMLMAPPER"
