...
│   │   └── pom.xml
│   └── pom.xml
├── gknoone-cloud-plus-microservices
│   ├── gknoone-cloud-plus-microservices-hello
│   │   ├── src.main.java.com.gknoone.cloud.plus.microservices
...
│   │   └── pom.xml
│   └── pom.xml
├── gknoone-cloud-plus-microservices-api
│   ├── gknoone-cloud-plus-microservices-hello-api
│   │   ├── src.main.java.com.gknoone.cloud.plus.microservices
│   │   │                                        └── service
│   │   │                                            ├── hystrix
...
3. 说明
   ...
   - 所有的微服务都放在**src.main.java.com.gknoone.cloud.plus.microservices**目录下，方便扫描。
   ...
   - 采用openfeign继承的形式，实现统一管理
    ...
    - **service**：定义所有的FeignAPI接口
     ...
     - **gknoone-cloud-plus-microservices**：微服务核心实现区
       - **web**：存放路由
...
3. eureka-client配置：
   ...
   - **gknoone-cloud-plus-microservices-test**（作为调用方需开启熔断）
     ...
     logging:
       level:
         ...
         com.gknoone.cloud.plus.microservices.service: DEBUG
