...
.
├── uyaba-cloud-common
│   ├── uyaba-cloud-common-core
│   │   ├── src.main.java.com.uyaba.cloud.common.core
│   │   │                                               ├── config
│   │   │                                               ├── support
│   │   │                                               │   └── BaseController.java
│   │   │                                               └── wrapper
...
│   │   │                                                   └── Wrapper.java
│   │   └── pom.xml
│   ├── uyaba-cloud-common-feign
│   │   ├── src.main.java.com.uyaba.cloud.common.feign
│   │   │                                  						 └── FeignConfiguration.java
│   │   └── pom.xml
│   └── pom.xml
├── uyaba-cloud-microservices
│   ├── uyaba-cloud-microservices-hello
│   │   ├── src.main.java.com.uyaba.cloud.microservices
│   │   │       │                                ├── microservicesHelloApplication.java
│   │   │       │                                ├── server
│   │   │       │                                │	 └── impl
│   │   │       │                                └── web
│   │   │       │                                    ├── controller
...
│   │   ├── src.main.java.com.uyaba.cloud.microservices
│   │   │       │                                ├── microservicesTestApplication.java
│   │   │       │                                ├── server
│   │   │       │                                │	 └── impl
│   │   │       │                                └── web
│   │   │       │                                    └── controller
...
│   │   └── pom.xml
│   └── pom.xml
├── uyaba-cloud-microservices-api
│   ├── uyaba-cloud-microservices-hello-api
│   │   ├── src.main.java.com.uyaba.cloud.microservices
│   │   │                                        └── service
│   │   │                                            ├── hystrix
...
3. 说明
   ...
   - 所有的微服务都放在**src.main.java.com.uyaba.cloud.microservices**目录下，方便扫描。
   ...
   - 采用openfeign继承的形式，实现统一管理
     ...
     - **uyaba-cloud-microservices**：微服务核心实现区
       - **web**：存放路由
...
1. 引入依赖
   ...
   <dependency>
     <groupId>com.uyaba.cloud</groupId>
...
3. eureka-client配置：
   ...
   - **uyaba-cloud-microservices-test**（作为调用方需开启熔断）
     ...
     logging:
       level:
         ...
         com.uyaba.cloud.microservices.service: DEBUG
