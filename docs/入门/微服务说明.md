...
.
├── uyaki-cloud-common
│   ├── uyaki-cloud-common-core
│   │   ├── src.main.java.com.uyaki.cloud.common.core
│   │   │                                               ├── config
│   │   │                                               ├── support
│   │   │                                               │   └── BaseController.java
│   │   │                                               └── wrapper
...
│   │   │                                                   └── Wrapper.java
│   │   └── pom.xml
│   ├── uyaki-cloud-common-feign
│   │   ├── src.main.java.com.uyaki.cloud.common.feign
│   │   │                                  						 └── FeignConfiguration.java
│   │   └── pom.xml
│   └── pom.xml
├── uyaki-cloud-microservices
│   ├── uyaki-cloud-microservices-hello
│   │   ├── src.main.java.com.uyaki.cloud.microservices
...
│   │   └── pom.xml
│   └── pom.xml
├── uyaki-cloud-microservices-api
│   ├── uyaki-cloud-microservices-hello-api
│   │   ├── src.main.java.com.uyaki.cloud.microservices
│   │   │                                        └── service
│   │   │                                            ├── hystrix
...
3. 说明
   ...
   - 所有的微服务都放在**src.main.java.com.uyaki.cloud.microservices**目录下，方便扫描。
   ...
   - 采用openfeign继承的形式，实现统一管理
     ...
     - **uyaki-cloud-microservices**：微服务核心实现区
       - **web**：存放路由
...
3. eureka-client配置：
   ...
   - **uyaki-cloud-microservices-test**（作为调用方需开启熔断）
     ...
     logging:
       level:
         ...
         com.uyaki.cloud.microservices.service: DEBUG
